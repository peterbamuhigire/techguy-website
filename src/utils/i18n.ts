...
const ui = {
  en: {
    ...
    'websites.meta_description': 'Website design portfolio by Peter Bamuhigire — professional websites for businesses across Africa and the UK. Astro, Tailwind CSS, modern web standards.',
  ...
  fr: {
    ...
    'websites.meta_description': 'Portfolio de sites web par Peter Bamuhigire — sites professionnels pour entreprises en Afrique et au Royaume-Uni. Astro, Tailwind CSS et standards web modernes.',
